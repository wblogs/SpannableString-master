...
public class MainActivity extends BaseActivity {
    ...
    private void initView08() {
        SpannableString spannableString08 = new SpannableString("这里可以添加图片");
        //设置图片
        Drawable d = ResourcesCompat.getDrawable(getResources(), R.mipmap.ic_launcher, null);
        d.setBounds(0, 0, 45, 45);
        spannableString08.setSpan(new ImageSpan(d), 2, 3, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        textView08.setText(spannableString08);
    }
    ...
    private void initView02() {
        ...
        URLSpan urlSpan = new URLSpan("https://wblogs.github.io");
